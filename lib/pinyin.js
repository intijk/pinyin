...
class Pinyin {
  ...
  static toFixed (pinyin, style) {
    ...
    case PINYIN_STYLE.FIRST_CAPITAL:
      var normal = pinyin.replace(RE_PHONETIC_SYMBOL, function($0, $1_phonetic){
        return PHONETIC_SYMBOL[$1_phonetic].replace(RE_TONE2, "$1");
      });
  ...
  static get STYLE_FIRST_CAPITAL () {
    return PINYIN_STYLE.FIRST_CAPITAL;
  }
